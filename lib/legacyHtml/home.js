...
<!-- HERO -->
<div class="hero">
  <div class="hero-eyebrow"><span></span> Start with a free trial — no card required</div>
  <h1>AI tools built for<br><em>every</em> <span class="grad">content creator</span></h1>
  <p class="hero-sub">14 AI tools for content creators — hashtags, captions, bios, threads, SEO intros, ad copy, viral hooks, and more. Try it free, upgrade when you're ready to go unlimited.</p>
  <div class="hero-actions">
    <a href="#tools" class="btn-hero btn-hero-primary">Start your free trial →</a>
  ...
  <div class="stats">
    ...
    <div class="stat-item"><div class="stat-num" style="color:var(--a2)">3-Day</div><div class="stat-label">Free trial</div></div>
    <div class="stat-item"><div class="stat-num" style="color:var(--a3)">⚡</div><div class="stat-label">Fast results</div></div>
    <div class="stat-item"><div class="stat-num" style="color:var(--a4)">3</div><div class="stat-label">Flexible plans</div></div>
  </div>
</div>
...
<div class="trust-bar">
  <div class="trust-inner">
    <div class="trust-item"><span class="trust-icon">✅</span> Free trial, no card required</div>
...
<div class="tools-section" id="tools">
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="ht-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('ht-empty','ht-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="cap-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('cap-empty','cap-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="bio-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('bio-empty','bio-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="vid-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('vid-empty','vid-result')">🗑 Clear</button>
        </div>
  ...
  <div class="tool-panel" id="panel-thread">
    <div class="input-panel">
      ...
      <div class="ml-hint">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
        Works for Twitter/X and LinkedIn — included in your free trial.
      </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="thr-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('thr-empty','thr-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="seo-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('seo-empty','seo-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="rp-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('rp-empty','rp-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="yt-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('yt-empty','yt-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="es-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('es-empty','es-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="cta-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('cta-empty','cta-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="ad-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('ad-empty','ad-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="vh-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('vh-empty','vh-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="tw-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('tw-empty','tw-result')">🗑 Clear</button>
        </div>
    ...
    <div class="output-panel">
      ...
      <div class="out-result" id="pt-result">
        <div class="out-topbar">
          ...
          <button class="copy-btn" onclick="clearOutput('pt-empty','pt-result')">🗑 Clear</button>
        </div>
...
<div class="faq-section" id="faq">
  ...
  <div class="faq-item">
    ...
    <div class="faq-a">SocialToolkit isn't free forever, but you don't need a card to try it. Creating an account gives you a free trial with no cost and no commitment, so you can test the tools, save your favorite results, and explore the content calendar and templates before deciding on a plan. Once your trial ends, continued use requires a Premium or Pro subscription, or pay-as-you-go credits — see "How many times can I use the tools?" below for details.</div>
  </div>
  <div class="faq-item">
    <div class="faq-q" onclick="toggleFaq(this)">Do you store my data?</div>
    <div class="faq-a">We take your privacy seriously. Your account info and anything you choose to save is stored securely and never sold to third parties. Saved/favorited results are automatically deleted after 3 months. Please read our <a href="/privacy">Privacy Policy</a> for full details.</div>
  </div>
  <div class="faq-item">
  ...
  <div class="faq-item">
    ...
    <div class="faq-a">Your free trial gives you a daily allowance of generations to explore the tools risk-free — enough to see real results before you decide on a plan. Once the trial ends, you can subscribe to Premium for unlimited generations, or Pro for unlimited access plus advanced tools like Ad Copy, Viral Hooks, Technical Writing, and Brand Pitch Writer — or top up with pay-as-you-go credits if you'd rather not subscribe.</div>
  </div>
  <div class="faq-item">
...
<div class="cta-banner">
  ...
  <p>AI tools for every creator. Start with a free trial — no credit card needed.</p>
  <a href="#tools" class="btn-hero btn-hero-primary">Start your free trial →</a>
</div>
