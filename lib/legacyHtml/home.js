...
<!-- HERO -->
<div class="hero">
  <div class="hero-eyebrow"><span></span> Free to start — 10 generations/day</div>
  ...
  <div class="stats">
    ...
    <div class="stat-item"><div class="stat-num" style="color:var(--a2)">10</div><div class="stat-label">Free daily uses</div></div>
...
<div class="trust-bar">
  <div class="trust-inner">
    <div class="trust-item"><span class="trust-icon">✅</span> Free to try, no card required</div>
...
<div class="faq-section" id="faq">
  ...
  <div class="faq-item">
    ...
    <div class="faq-a">You can try most tools without an account, and every account gets 10 free generations per day at no cost, no credit card required. Creating a free account also unlocks saving your favorite results, a content calendar, and templates. Premium and Pro plans remove the daily limit and unlock advanced tools — see "How many times can I use the tools?" below for details.</div>
  </div>
  <div class="faq-item">
...
<div class="cta-banner">
  ...
  <p>AI tools for every creator. Free to start — 10 generations/day, no credit card needed.</p>
  <a href="#tools" class="btn-hero btn-hero-primary">Start creating free →</a>
</div>
